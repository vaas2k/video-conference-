    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Join a meeting</CardTitle>
            ...
            <CardContent>
              <div className="flex space-x-2">
                ...
                />
                <Button onClick={handleJoinMeeting} disabled={!meetingId}>
                  Join
                </Button>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Create a meeting</CardTitle>
        ...
        <h2 className="text-2xl font-semibold mt-12 mb-4">Upcoming meetings</h2>
        <Card>
